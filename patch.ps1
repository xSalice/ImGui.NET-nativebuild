...
$cppContent = $cppContent -replace 'IMGUI_IMPL_API LRESULT ImGui_ImplWin32_WndProcHandlerEx\(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam, ImGuiIO& io\)', 'static IMGUI_IMPL_API LRESULT CALLBACK ImGui_ImplWin32_WndProcHandlerEx(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam, ImGuiIO& io)'
